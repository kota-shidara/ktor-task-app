---
name: commit-push-pr
description: 現在の変更をコミットしてプッシュし、必要に応じてPRを作成する。コードの変更をシップしたい時に使用する。
---

# Ship Changes

現在の変更をコミットしてプッシュし、必要に応じてPRを作成します。
...
- PRが存在しない場合は、ユーザーにPRを作成するか確認
- PRを作成する場合は `gh pr create` を使用し、変更内容に基づいたタイトルと説明を生成
