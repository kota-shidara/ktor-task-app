...
description: 会話履歴を分析し、プロジェクトのナレッジとして残すべき新しいルールやパターンを提案する。会話の中で繰り返し出てきたパターンや規約をキャプチャしたい時に使用する。
---
...
| 長いガイドライン | 参照ドキュメント | API設計ガイド、詳細なコーディング規約など（`docs/*.md`に保存し、CLAUDE.mdから参照） |
...
```
会話履歴を分析しました。以下の内容を追記しませんか？

追記した方がよさそうであれば、「この内容を追記してください」のように指示してください。

---

## 提案1: [タイトル]

**保存先**: [CLAUDE.md / 参照ドキュメント（docs/xxx.md） / Skills / Subagent]
